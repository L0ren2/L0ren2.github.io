...
#+REVEAL_TITLE_SLIDE: <img style="height: 250px;padding: 20px;" src="img/Tux.png"/><img style="height: 250px;padding: 20px;" src="img/qr-linux-present.png"/><br/><br/>
#+REVEAL_TITLE_SLIDE: %a <br/><br/> L0ren2.github.io/linux-present
